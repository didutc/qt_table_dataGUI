...
"")
    ...
    def linkevent(self):
        ...
        y = t.replace(' ','-')
        webbrowser.open("https://ko.aliexpress.com/af/"+y+".html?spm")
        ...
        res = res.split('"translatedText":"')[1].split('"')[0]
        string_encoded = parse.quote(res, encoding="EUC-CN")
        res = res.replace(' ','+')
        webbrowser.open("https://s.taobao.com/search?initiative_id=staobaoz_20230205&q="+res)
        



        webbrowser.open("https://s.1688.com/selloffer/offer_search.htm?keywords="+string_encoded)
        ########################### en ####################################
        ...
        res = res.split('"translatedText":"')[1].split('"')[0]
        res = res.replace(' ','+')
        webbrowser.open("https://www.amazon.com/s?k="+res)
        webbrowser.open("https://www.alibaba.com/trade/search?fsb=y&IndexArea=product_en&CatId=&tab=all&SearchText="+res)
        ...
        res = res.split('"translatedText":"')[1].split('"')[0]
        res = res.replace(' ','+')
        webbrowser.open("https://search.rakuten.co.jp/search/mall/"+res+'/')
